...
def categories():
  ...
  return render_template('categories.html', title="Categories index",
...
def category(id_category):
  ...
  return render_template('category.html', title="Category", title_setting="Category",
                         category=category_db, items=items)
